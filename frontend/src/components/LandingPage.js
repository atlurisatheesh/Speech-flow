...
import { Mic, Sparkles, Zap, Globe, Keyboard, Code, FileText, MessageSquare, Download, ArrowRight } from 'lucide-react';
    ...
    <div className="landing-page-wrapper">
      <nav>
        <div className="container nav-content">
          ...
          <Link to="/app" className="btn-secondary" style={{textDecoration: 'none'}}>
            Launch App
            <ArrowRight size={16} />
          </Link>
        </div>
      ...
      <footer>
        <div className="container">
          ...
          <Link to="/app" className="btn-primary" style={{ marginBottom: '40px', textDecoration: 'none' }}>
            <Sparkles size={20} />
            Start Using Speech-Flow Now
          </Link>
